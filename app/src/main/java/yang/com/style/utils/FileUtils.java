...
public class FileUtils {
    ...
    private static final String APP_DIR = "Style";

    private static final String TEMP_DIR = "Style/.TEMP";
    ...
    public static String saveBitmapToLocal(Bitmap bm, Context context) {
        String path = null;
        try {
            File file = FileUtils.getInstance(context).createTempFile("IMG_Style", ".jpg");
